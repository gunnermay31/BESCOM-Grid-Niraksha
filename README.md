...
This is a multi-service architecture requiring three running servers.

### 1. ML Backend Server (Port 8001)
This service handles ML predictions and node-level forecasting.
```bash
cd backend
...
This service integrates geospatial and live telemetry.
```bash
...
### Accessing the App
After all servers are running, open your browser and navigate to:
**http://localhost:3000**
